...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About PRAGMATA Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about PRAGMATA Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the PRAGMATA Steam game.',
    keywords: [
      'about PRAGMATA Wiki',
      'PRAGMATA community',
      'Steam game wiki',
    ...
    openGraph: {
      ...
      siteName: 'PRAGMATA Wiki',
      title: 'About PRAGMATA Wiki',
      description: 'Learn about our mission to provide the best PRAGMATA game resources and guides.',
      images: [
        {
    ...
    twitter: {
      ...
      title: 'About PRAGMATA Wiki',
      description: 'Learn about our mission to provide the best PRAGMATA game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for PRAGMATA
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to PRAGMATA Wiki</h2>
            <p>
              PRAGMATA Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "PRAGMATA". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              PRAGMATA Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower PRAGMATA players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision PRAGMATA Wiki as the <strong>go-to destination</strong> for every PRAGMATA player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              PRAGMATA Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              PRAGMATA Wiki is maintained by a dedicated team of passionate gamers and developers who love
              PRAGMATA as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of PRAGMATA mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>PRAGMATA Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of PRAGMATA or any official entities.
            </p>
            <p>
            ...
            <p>
              PRAGMATA Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@pragmata.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@pragmata.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@pragmata.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@pragmata.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@pragmata.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@pragmata.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@pragmata.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@pragmata.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and PRAGMATA news.
